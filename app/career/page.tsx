...
const PROJECTS: ProjectData[] = [
  {
    ...
    problem: [
      '기존 리포트는 <b>미션 완료 여부만 테이블로 나열</b>하는 수준 — 광고주가 한 번 보고 닫으면 그만인 정적 페이지',
  ...
  },
  {
    ...
    phases: [
      {
        ...
        results: [
          { metric: '50% / 25%', label: 'FE 분담률 (평균 대비 2배)' },
          { metric: '2개 동시', label: '한·일 앱 출시' },
          { metric: '0건', label: '다음 분기 일정 이월' },
        ],
      },
      {
        ...
        results: [
          { metric: '1–2개월 → 16일', label: '정체 프로젝트 출시' },
          { metric: '70%', label: '단독 참여율' },
          { metric: '100%', label: '목표 달성률' },
        ],
      },
      {
        ...
        results: [
          { metric: '0 → 2개', label: '한·일 독립 배포 파이프라인' },
          { metric: '100%', label: '참여율 · 기여도' },
          { metric: '사전 제거', label: '의존성 병목 리스크' },
        ],
      },
      {
        ...
        results: [
          { metric: '10/10 → 12/3', label: '이관 출시, 일정 준수' },
          { metric: '100%', label: 'FE 단독 참여율' },
          { metric: '0건', label: '광고주 신청 채널 단절' },
        ],
      },
      {
        ...
        results: [
          { metric: '0 / 0 / 0', label: 'BE 공수 · 디자이너 공수 · 신규 API' },
    ...
    results: [
      ...
      { metric: '0 → 2개', label: '독립 배포 파이프라인' },
      { metric: '16일', label: '정체 프로젝트 출시' },
      { metric: '0건', label: '광고주 채널 단절' },
    ],
  },
]
